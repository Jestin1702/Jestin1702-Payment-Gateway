!function(e, t) {
    ...
    function f(e, t, n, r) {
        ...
        n = n || "=",
        null === e && (e = void 0),
        "object" == typeof e ? d(Vn(e), function(r) {
    ...
    var g, v = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {}, y = (e(function(e, t) {
        (function() {
            function n(e, t) {
                ...
                t.parse = d.parse);
                var h, g, v, y = u.prototype, m = y.toString, _ = new c(-0xc782b5b800cec);
                try {
                ...
                if (!o("json")) {
                          ...
                          , N = function(e, t, n, r, o, i, s) {
                            ...
                            if ("object" == typeof a && a)
                                if ("[object Date]" != (u = m.call(a)) || h.call(a, "toJSON"))
                                    ...
                                    if (E) {
                                        for (f = w(a / 864e5),
                                        c = w(f / 365.2425) + 1970 - 1; E(c + 1, 0) <= f; c++)
                                            ;
                                        for (p = w((f - E(c, 0)) / 30.42); E(c, p + 1) <= f; p++)
                                            ;
                                        f = 1 + f - E(c, p),
                                        y = w((d = (a % 864e5 + 864e5) % 864e5) / 36e5) % 24,
                                        _ = w(d / 6e4) % 60,
                                        b = w(d / 1e3) % 60,
                                        I = d % 1e3
                                    } else
                                    ...
                                    a = (c <= 0 || c >= 1e4 ? (c < 0 ? "-" : "+") + C(6, c < 0 ? -c : c) : C(4, c)) + "-" + C(2, p + 1) + "-" + C(2, f) + "T" + C(2, y) + ":" + C(2, _) + ":" + C(2, b) + "." + C(3, I) + "Z"
                                } else
                                    a = null;
                            if (n && (a = n.call(t, e, a)),
                            null === a)
                        ...
                        t.stringify = function(e, t, n) {
                            ...
                            if (r[typeof t] && t)
                                if ("[object Function]" == (a = m.call(t)))
                                    ...
                                    s = {};
                                    for (var u, c = 0, p = t.length; c < p; u = t[c++],
                                    ("[object String]" == (a = m.call(u)) || "[object Number]" == a) && (s[u] = 1))
                                        ;
                                }
                            if (n)
                    ...
                    if (!o("json-parse")) {
                        var T, A, j = a.fromCharCode, x = {
                            ...
                            for (var e, t, n, r, o, i = A, s = i.length; T < s; )
                                ...
                                default:
                                    ...
                                    o = i.charCodeAt(++T)),
                                    o >= 48 && o <= 57) {
                                        for (48 == o && (o = i.charCodeAt(T + 1)) >= 48 && o <= 57 && P(),
                                        r = !1; T < s && (o = i.charCodeAt(T)) >= 48 && o <= 57; T++)
                                            ;
                                        ...
                                        if (101 == (o = i.charCodeAt(T)) || 69 == o) {
                                            for (43 != (o = i.charCodeAt(++T)) && 45 != o || T++,
                                            n = T; n < s && (o = i.charCodeAt(n)) >= 48 && o <= 57; n++)
                                                ;
                                            n == T && P(),
                                            T = n
                                        }
                            ...
                            "string" == typeof e) {
                                ...
                                if ("{" == e) {
                                    for (t = {}; "}" != (e = k()); n || (n = !0))
                                        n && ("," == e ? "}" == (e = k()) && P() : P()),
                                        "," != e && "string" == typeof e && "@" == (b ? e.charAt(0) : e[0]) && ":" == k() || P(),
                                        t[e.slice(1)] = R(k());
                                    return t
                                }
                                P()
                        ...
                        t.parse = function(e, t) {
                            ...
                            "$" != k() && P(),
                            T = A = null,
                            t && "[object Function]" == m.call(t) ? U((r = {},
                            r[""] = n,
                            r), "", t) : n
                        }
                    }
            ...
            if (!s || s.global !== s && s.window !== s && s.self !== s || (i = s),
            o)
                n(i, o);
            else {
                var a = i.JSON
    ...
    }),
    {
        ...
        _encode: function(e) {
            ...
            for (e = m.encode(e); c < e.length; )
                ...
                u = u + _._keyStr.charAt(o) + _._keyStr.charAt(i) + _._keyStr.charAt(s) + _._keyStr.charAt(a);
            return u
        },
        decode: function(e) {
            try {
        ...
        _decode: function(e) {
            ...
            for (e = e.replace(/[^A-Za-z0-9\+\/\=]/g, ""); u < e.length; )
                t = _._keyStr.indexOf(e.charAt(u++)) << 2 | (o = _._keyStr.indexOf(e.charAt(u++))) >> 4,
                n = (15 & o) << 4 | (i = _._keyStr.indexOf(e.charAt(u++))) >> 2,
    ...
    }), w = 1e3, I = 60 * w, E = 60 * I, S = 24 * E, C = 365.25 * S, O = function(e, n) {
        n = n || {};
        var r = typeof e;
    ...
    , P = Object.prototype.toString, k = function(e) {
        ...
        for (var r in e)
            if (e.hasOwnProperty(r)) {
                var o = r
                  , i = k(o);
                "string" !== i && (o = String(o),
                U.warn("WARNING: Non-string property key, received type " + i + ', coercing to string "' + o + '"'));
                var s = V(o, e[r]);
                null !== s && (n[o] = s)
            }
        return n
    }, L = ["null", "nan", "undefined", "function", "arguments", "regexp", "element"], V = function e(t, n) {
        var r = k(n);
        if (-1 !== L.indexOf(r))
            U.warn('WARNING: Property key "' + t + '" with invalid value type ' + r + ", ignoring"),
            n = null;
        else if ("error" === r)
            n = String(n),
        ...
        if ("array" === n) {
            for (var r = [], o = 0; o < t.length; o++) {
                ...
                U.warn("WARNING: Non-string groupName, received type " + s + ', coercing to string "' + i + '"'),
                r.push(i)) : U.warn("WARNING: Skipping nested " + s + " in array groupName")
            }
            return r
        }
            ...
            for (var r in e)
                if (e.hasOwnProperty(r)) {
                    var o = r
                      , i = k(o);
                    "string" !== i && (o = String(o),
                    U.warn("WARNING: Non-string groupType, received type " + i + ', coercing to string "' + o + '"'));
                    var s = z(o, e[r]);
                    null !== s && (n[o] = s)
                }
            return n
        ...
        validateInput: function(e, t, n) {
            return k(e) === n || (U.error("Invalid " + t + " input type. Expected " + n + " but received " + k(e)),
            !1)
        },
        ...
        var t = "";
        return B.domain && (t = "." === B.domain.charAt(0) ? B.domain.substring(1) : B.domain),
        e + t
    }, $ = function(e) {
        try {
        ...
        try {
            return W(K(e), _.encode(JSON.stringify(t)), B),
            !0
        } catch (e) {
            return !1
        }
        ...
        options: function(e) {
            if (0 === arguments.length)
                return B;
            e = e || {},
            B.expirationDays = e.expirationDays;
            var t = G.isEmptyString(e.domain) ? "." + j(window.location.href) : e.domain
              , n = Math.random();
            B.domain = t,
            J("amplitude_test", n);
    ...
    if (function() {
        ...
        X.addBehavior && (X.addBehavior("#default#userdata"),
        g = {
            length: 0,
            ...
            key: function(e) {
                return X.load(H),
                X.XMLDocument.documentElement.attributes[e]
            }
        },
        X.load(H),
    ...
    ee.prototype.getStorage = function() {
        ...
        if (this._cookiesEnabled())
            ...
            this.storage = {
                ...
                set: function(e, t) {
                    try {
                        return Z.setItem("amp_cookiestore_" + e, JSON.stringify(t)),
                        !0
                    } catch (e) {}
                    return !1
                },
    ...
    te.prototype.add = function(e, t) {
        return "number" === k(t) || "string" === k(t) ? this._addOperation("$add", e, t) : G.log.error("Unsupported type for value: " + k(t) + ", expecting number or string"),
        this
    }
    ,
    ...
    te.prototype.clearAll = function() {
        return Object.keys(this.userPropertiesOperations).length > 0 ? (this.userPropertiesOperations.hasOwnProperty("$clearAll") || G.log.error("Need to send $clearAll on its own Identify object without any other operations, skipping $clearAll"),
    ...
    te.prototype._addOperation = function(e, t, n) {
        this.userPropertiesOperations.hasOwnProperty("$clearAll") ? G.log.error("This identify already contains a $clearAll operation, skipping operation " + e) : -1 === this.properties.indexOf(t) ? (this.userPropertiesOperations.hasOwnProperty(e) || (this.userPropertiesOperations[e] = {}),
        this.userPropertiesOperations[e][t] = n,
        this.properties.push(t)) : G.log.error('User property "' + t + '" already used in this identify, skipping operation ' + e)
    }
    ;
    var ne = e(function(e) {
        !function(t) {
            ...
            function h(e, t) {
                return function(e, t) {
                    ...
                    n = 0; n < 16; n += 1)
                        i[n] = 909522486 ^ o[n],
                        s[n] = 1549556828 ^ o[n];
                    return r = u(i.concat(p(t)), 512 + 8 * t.length),
                    c(u(s.concat(r), 640))
                }(f(e), f(t))
            }
            function g(e, t, n) {
    ...
    var le = i
      ...
      , Ke = Ge.toString
      , $e = Be.hasOwnProperty
      , Je = RegExp("^" + Ke.call($e).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$")
      , We = function(e) {
    ...
    var _t = u
      ...
      , rn = {};
    rn["[object Float32Array]"] = rn["[object Float64Array]"] = rn["[object Int8Array]"] = rn["[object Int16Array]"] = rn["[object Int32Array]"] = rn["[object Uint8Array]"] = rn["[object Uint8ClampedArray]"] = rn["[object Uint16Array]"] = rn["[object Uint32Array]"] = !0,
    rn["[object Arguments]"] = rn["[object Array]"] = rn["[object ArrayBuffer]"] = rn["[object Boolean]"] = rn["[object DataView]"] = rn["[object Date]"] = rn["[object Error]"] = rn["[object Function]"] = rn["[object Map]"] = rn["[object Number]"] = rn["[object Object]"] = rn["[object RegExp]"] = rn["[object Set]"] = rn["[object String]"] = rn["[object WeakMap]"] = !1;
    var on = function(e) {
        ...
        if (c)
            ...
            if (l) {
                var f = Gt(u)
                  ...
                  , h = !f && !d && cn(u);
                p = u,
                f || d || h ? Gt(a) ? p = a : Jt(a) ? p = Tt(a) : d ? (l = !1,
                p = St(u, !0)) : h ? (l = !1,
                p = Nt(u, !0)) : p = [] : nn(u) || zt(u) ? (p = a,
                zt(a) ? p = En(a) : (!xe(a) || r && Ue(a)) && (p = Ft(u))) : l = !1
            }
            l && (s.set(u, p),
            o(p, u, r, i, s),
            s.delete(u)),
      ...
      , Tn = Math.max
      , An = function(e, t, n) {
        return t = Tn(void 0 === t ? e.length - 1 : t, 0),
        function() {
    ...
    Bn.prototype.setProductId = function(e) {
        return "string" !== k(e) ? G.log.error("Unsupported type for productId: " + k(e) + ", expecting string") : G.isEmptyString(e) ? G.log.error("Invalid empty productId") : this._productId = e,
        this
    }
    ,
    Bn.prototype.setQuantity = function(e) {
        return "number" !== k(e) ? G.log.error("Unsupported type for quantity: " + k(e) + ", expecting number") : this._quantity = parseInt(e),
        this
    }
    ,
    Bn.prototype.setPrice = function(e) {
        return "number" !== k(e) ? G.log.error("Unsupported type for price: " + k(e) + ", expecting number") : this._price = e,
        this
    }
    ,
    Bn.prototype.setRevenueType = function(e) {
        return "string" !== k(e) ? G.log.error("Unsupported type for revenueType: " + k(e) + ", expecting string") : this._revenueType = e,
        this
    }
    ,
    Bn.prototype.setEventProperties = function(e) {
        return "object" !== k(e) ? G.log.error("Unsupported type for eventProperties: " + k(e) + ", expecting object") : this._properties = G.validateProperties(e),
        this
    }
    ,
    Bn.prototype._isValidRevenue = function() {
        return "number" === k(this._price) || (G.log.error("Invalid revenue, need to set price field"),
        !1)
    }
    ,
    Bn.prototype._toJSONObject = function() {
        var e = "object" === k(this._properties) ? this._properties : {};
        return null !== this._productId && (e[y.REVENUE_PRODUCT_ID] = this._productId),
        null !== this._quantity && (e[y.REVENUE_QUANTITY] = this._quantity),
        null !== this._price && (e[y.REVENUE_PRICE] = this._price),
        null !== this._revenueType && (e[y.REVENUE_REVENUE_TYPE] = this._revenueType),
        e
    }
    ;
    var Kn = e(function(e, t) {
            ...
            var o = "model"
                        ...
                        for (t = n = 0; t < c.length && !i; )
                            if (i = c[t++].exec(this.getUA()))
                                for (r = 0; r < p.length; r++)
                                    s = i[++n],
                                    "object" == typeof (o = p[r]) && o.length > 0 ? 2 == o.length ? "function" == typeof o[1] ? e[o[0]] = o[1].call(this, s) : e[o[0]] = o[1] : 3 == o.length ? "function" != typeof o[1] || o[1].exec && o[1].test ? e[o[0]] = s ? s.replace(o[1], o[2]) : void 0 : e[o[0]] = s ? o[1].call(this, s, o[2]) : void 0 : 4 == o.length && (e[o[0]] = s ? o[3].call(this, s.replace(o[1], o[2])) : void 0) : e[o] = s || void 0;
                        a += 2
                    }
                    return e
                },
              ...
              , g = function(e, t) {
                ...
                return this.getBrowser = function() {
                    ...
                    return e.major = l.major(e.version),
                    e
                }
                ,
      ...
      , Wn = function(e) {
        this._instanceName = G.isEmptyString(e) ? y.DEFAULT_INSTANCE : e.toLowerCase(),
        this._legacyStorageSuffix = this._instanceName === y.DEFAULT_INSTANCE ? "" : "_" + this._instanceName,
        this._unsentEvents = [],
    ...
    Wn.prototype.init = function(e, t, n, r) {
        if ("string" !== k(e) || G.isEmptyString(e))
            ...
            try {
                ...
                Yn(this.options, n),
                "string" === k(this.options.logLevel) && G.setLogLevel(this.options.logLevel);
                var o = rr(this);
                if (this._apiPropertiesTrackingOptions = Object.keys(o).length > 0 ? {
                    tracking_options: o
                } : {},
                ...
                Xn(this),
                this.options.deviceId = "object" === k(n) && "string" === k(n.deviceId) && !G.isEmptyString(n.deviceId) && n.deviceId || this.options.deviceIdFromUrlParam && this._getDeviceIdFromUrlParam(this._getUrlParams()) || this.options.deviceId || $n() + "R",
                this.options.userId = "string" === k(t) && !G.isEmptyString(t) && t || "number" === k(t) && t.toString() || this.options.userId || null,
                this.options.saveEvents) {
                    ...
                    for (var i = 0; i < this._unsentEvents.length; i++) {
                        ...
                        this._unsentEvents[i].event_properties = G.validateProperties(s),
                    ...
                    for (var u = 0; u < this._unsentIdentifys.length; u++) {
                        ...
                        this._unsentIdentifys[u].user_properties = G.validateProperties(c),
                        this._unsentIdentifys[u].groups = G.validateGroups(p)
                    }
                }
                var l = (new Date).getTime();
                (!this._sessionId || !this._lastEventTime || l - this._lastEventTime > this.options.sessionTimeout) && (this._newSession = !0,
                this._sessionId = l,
    ...
    Wn.prototype._apiKeySet = function(e) {
        return !G.isEmptyString(this.options.apiKey) || (G.log.error("Invalid apiKey. Please set a valid apiKey with init() before calling " + e),
        !1)
    }
    ,
    Wn.prototype._loadSavedUnsentEvents = function(e) {
        ...
        return this._removeFromLegacyStorage(Z, e),
    ...
    var Qn = function(e) {
        ...
        if ("object" !== k(t) && (t = e.cookieStorage.get(e.options.cookieName + e._legacyStorageSuffix),
        !("object" === k(t) && t.deviceId && t.sessionId && t.lastEventTime))) {
            var n = function(e) {
                var t = Z.getItem(e);
                return Z.removeItem(e),
                t
            }
              , r = "string" === k(e.options.apiKey) && "_" + e.options.apiKey.slice(0, 6) || ""
              , o = n(y.DEVICE_ID + r)
              , i = n(y.USER_ID + r)
              , s = n(y.OPT_OUT + r);
      ...
      , Xn = function(e) {
        ...
        if ("object" === k(t))
            ...
            "object" === k(n) && (e.cookieStorage.remove(e.options.cookieName + e._legacyStorageSuffix),
            Hn(e, n))
        }
    }
      , Hn = function(e, t) {
    ...
    Wn.prototype.setDeviceId = function(e) {
        if (G.validateInput(e, "deviceId", "string"))
            try {
                G.isEmptyString(e) || (this.options.deviceId = "" + e,
                Zn(this))
            } catch (e) {
                G.log.error(e)
            }
    ...
    Wn.prototype.identify = function(e, t) {
        if (this._apiKeySet("identify()"))
            if ("object" === k(e) && e.hasOwnProperty("_q") && (e = tr(new te, e)),
            e instanceof te) {
                ...
                "function" === k(t) && t(0, "No request sent", {
                    reason: "No user property operations"
                })
            } else
                G.log.error("Invalid identify input type. Expected Identify object but saw " + k(e)),
                "function" === k(t) && t(0, "No request sent", {
    ...
    Wn.prototype.groupIdentify = function(e, t, n, r) {
        if (this._apiKeySet("groupIdentify()"))
            if (G.validateInput(e, "group_type", "string") && !G.isEmptyString(e))
                if (null !== t && void 0 !== t)
                    if ("object" === k(n) && n.hasOwnProperty("_q") && (n = tr(new te, n)),
                    n instanceof te) {
                        ...
                        "function" === k(r) && r(0, "No request sent", {
                            reason: "No group property operations"
                        })
                    } else
                        G.log.error("Invalid identify input type. Expected Identify object but saw " + k(n)),
                        "function" === k(r) && r(0, "No request sent", {
                            reason: "Invalid identify input type"
                        });
                else
    ...
    Wn.prototype._logEvent = function(e, t, n, r, o, i, s, a) {
        ...
        e)
            if (this.options.optOut)
                "function" === k(a) && a(0, "No request sent", {
                ...
                try {
                    ...
                    return e === y.IDENTIFY_EVENT || e === y.GROUP_IDENTIFY_EVENT ? (this._unsentIdentifys.push(f),
                    this._limitEventsQueued(this._unsentIdentifys)) : (this._unsentEvents.push(f),
                    this._limitEventsQueued(this._unsentEvents)),
                    this.options.saveEvents && this.saveEvents(),
                    this._sendEventsIfReady(a) || "function" !== k(a) || a(0, "No request sent", {
    ...
    Wn.prototype.logEventWithTimestamp = function(e, t, n, r) {
        return this._apiKeySet("logEvent()") ? G.validateInput(e, "eventType", "string") ? G.isEmptyString(e) ? ("function" === k(r) && r(0, "No request sent", {
            reason: "Missing eventType"
        }),
        -1) : this._logEvent(e, t, null, null, null, null, n, r) : ("function" === k(r) && r(0, "No request sent", {
            reason: "Invalid type for eventType"
        }),
        -1) : ("function" === k(r) && r(0, "No request sent", {
    ...
    Wn.prototype.logEventWithGroups = function(e, t, n, r) {
        return this._apiKeySet("logEventWithGroups()") ? G.validateInput(e, "eventType", "string") ? this._logEvent(e, t, null, null, n, null, null, r) : ("function" === k(r) && r(0, "No request sent", {
            reason: "Invalid type for eventType"
        }),
        -1) : ("function" === k(r) && r(0, "No request sent", {
            reason: "API key not set"
    ...
    Wn.prototype.logRevenueV2 = function(e) {
        if (this._apiKeySet("logRevenueV2()"))
            if ("object" === k(e) && e.hasOwnProperty("_q") && (e = tr(new Bn, e)),
            e instanceof Bn) {
    ...
    Wn.prototype.removeEvents = function(e, t) {
        ir(this, "_unsentEvents", e),
        ir(this, "_unsentIdentifys", t)
    }
    ;
    ...
    Wn.prototype.sendEvents = function(e) {
        if (this._apiKeySet("sendEvents()"))
            if (this.options.optOut)
                "function" === k(e) && e(0, "No request sent", {
                    reason: "optOut is set to true"
                });
                ...
                if (this._sending)
                    ...
                    new Gn(t,u).send(function(t, r) {
                        c._sending = !1;
                        try {
                            200 === t && "success" === r ? (c.removeEvents(o, i),
                            c.options.saveEvents && c.saveEvents(),
                            c._sendEventsIfReady(e) || "function" !== k(e) || e(t, r)) : 413 === t ? (1 === c.options.uploadBatchSize && c.removeEvents(o, i),
                            c.options.uploadBatchSize = Math.ceil(n / 2),
                            c.sendEvents(e)) : "function" === k(e) && e(t, r)
                        } catch (e) {}
                    })
                }
            else
